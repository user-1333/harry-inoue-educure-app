            ...
            <div className="flex gap-8 justify-center">
                ...
                <div className="flex flex-col gap-8">
                    <div className="flex gap-4">
                        <Button className={btnStyle("blue")}>出勤</Button>
                        <Button className={btnStyle("blue")}>退勤</Button>
                    </div>
                    <div className="flex gap-4">
                        <Button className={btnStyle("green")}>休憩開始</Button>
                        <Button className={btnStyle("green")}>休憩終了</Button>
                    </div>
                    <div className="flex gap-4">
                        <Button className={btnStyle("orange")}>遅刻</Button>
                        <Button className={btnStyle("orange")}>早退</Button>
                    </div>
                </div>
            </div>
        </div>
